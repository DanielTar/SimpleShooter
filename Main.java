...
//When running the game, use WASD to move and space to shoot a bullet towards the mouse.
public class Main implements Runnable{
    ...
    public void move() {
   	 ...
   	 double lx = clickedX - x;
   	 double ly = clickedY - y;
   	 ...
   	 if (space == true) {
   		 ...
   		 if (cooldownTimerBullets + 1 < System.currentTimeMillis()) {
   			 Bullet b = new Bullet();
   			 bullets.add(b);
   			 //if (isShot == false) {
   			 b.justStarted=true;
    ...
    public void checkBoundaries() {
   	 ...
   	 for (int i = bullets.size()-1; i > -1; i--)
   	 {
   		 ...
   		 /*if (bullets.get(i).shotLeft == false && bullets.get(i).shotRight == false && bullets.get(i).shotUp == false && bullets.get(i).shotDown == false) {
   			 bullets.get(i).X = arrow_X+5;
   			 bullets.get(i).Y = arrow_Y+5;
   		 }*/
   	 }   	 
    ...
    protected void render(Graphics2D g){
   	 ...
   	 //long cooldowdBulletDisp = (4000 - (System.currentTimeMillis() - cooldownTimerBullets))/1000;
